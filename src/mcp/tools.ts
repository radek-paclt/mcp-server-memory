...
export const tools = {
  ...
  search_memories: {
    ...
    inputSchema: z.object({
      ...
      customer_id: z.string().optional().describe('Filter by customer ID for customer-scoped memories'),
      interaction_id: z.string().optional().describe('Filter by interaction ID for conversation-scoped memories'),
    }),
  },
